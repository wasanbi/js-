...
function isdefined(檸樂、00,num)
{var tg= 檸樂、00.substring(0, 檸樂、00.indexOf("taskId")+7)+num+ 檸樂、00.substring(檸樂、00.indexOf("taskId")+15, 檸樂、00.length);if(tg.indexOf("sign")>0)
